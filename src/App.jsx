                ...
                )}
                {
                  projects.map(function(){fetch(`./projects/${project}/metadata.json`} => (project)) => {
                    ...
                    return (
                      <tr key={project.id}>
                        <td>{project.id}</td>
                        <td>{project.title}<br /><img src={`projects/${project.id}/thumbnail.png`} style={{width: 360, height: 480}}></img></td>
                      ...
                      <td style={{ backgroundColor: project.color }}>
                        ...
                        >
                          <img
                            ...
                            className="pfp"
                          ></img>
                          <span className="verticalcenter"> {author}</span>
                        </a>
                      </td>
                      <td>
                        {created.toLocaleDateString()}{" "}
